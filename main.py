        """
        Synthetic Data Gen Fsnd5e
        =========================
        Data engineering tool to deduplicate structured datasets with zero hassle.
...
from pathlib import Path
        ...
        APP_NAME    = "Synthetic Data Gen Fsnd5e"
        APP_VERSION = "1.0.0"
...
def _write_output(rows: list, path: Path, suffix: str) -> None:
    ...
    if suffix == ".csv" and rows:
        ...
        def build_parser() -> argparse.ArgumentParser:
            p = argparse.ArgumentParser(prog=APP_NAME, description="Data engineering tool to deduplicate structured datasets with zero hassle.")
